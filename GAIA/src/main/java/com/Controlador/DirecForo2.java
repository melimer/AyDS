 ...
 * @author karlaviles
 */
@WebServlet(name = "DirecForo2", urlPatterns = {"/DirecForo2"})
public class DirecForo2 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet DirecForo2</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet DirecForo2 at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (action.equalsIgnoreCase("cambia")) {
            ...
            HttpSession objSesion = request.getSession();
                ...
                response.sendRedirect("PagsDoctor/Foros/Foros.jsp");
